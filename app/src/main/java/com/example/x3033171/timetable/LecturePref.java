...
public interface LecturePref {

    /* 講義情報・履修コードの保存・読み込みに関するメソッド */
    // 時間割表に表示する講義の履修コードを保存するメソッド：MyLectureActivityの編集後に呼び出される
    default void writeLecCodes(Context context, Set<String> lecCodes) {
    ...
    default void writeLecInfo(Context context, ArrayList<Map<String, Object>> resultMaps) {
    ...
    @NotNull
    default Set<String> readLecCodes(Context context) {
        SharedPreferences preferences = context.getSharedPreferences("pref-lecCodes", Context.MODE_PRIVATE);
    ...
    @NotNull
    default ArrayList<Map<String, Object>> readLecInfo(Context context, Set<String> lecCodes) {
    ...
    @NotNull
    default Set<String> readAllLecCodes(Context context) {
        SharedPreferences preferences = context.getSharedPreferences("pref-lecInfo", Context.MODE_PRIVATE);
    ...
    @NotNull
    default ArrayList<Map<String, Object>> readAllLecInfo(Context context) {
        ArrayList<Map<String, Object>> resultMaps = new ArrayList<>();
